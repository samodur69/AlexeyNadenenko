Feature: Interaction with JDI homepage
  ...
  Scenario: User Table Page test (Exercise 2)
    ...
    And 6 Number Type DrI open JDI GitHub siteopdowns should be displI click on {string} button in Headerayed on Users Table on User Table Page
    And 6 arg0Usernames should be displayed on Users Table on User Table Page
